...
-- CreateIndex
CREATE UNIQUE INDEX "usage_records_userId_month_key" ON "usage_records"("userId", "month");
...
-- Delete existing connections (they have no user owner)
-- You will need to recreate them after signing in
DELETE FROM "connections";

-- AlterTable: Add userId column to connections
